...
alter table sales
add foreign key (customer_id) references test1_db.customers2(customer_id) on delete cascade; -- this is the better way to do the commented-out same thing above
